...
' Two-step JSON flow: upload then call /summarized-pdf-text with the uploaded id.
'''
    ...
    Module SummarizedPdfText
        Public Async Function Execute(args As String()) As Task
            If args Is Nothing OrElse args.Length < 1 Then
                Console.Error.WriteLine("Usage: dotnet run -- summarized-pdf-text /path/to/input.pdf")
                Environment.Exit(1)
            End If
            ...
            Using httpClient As New HttpClient()
                ...
                If Not resp.IsSuccessStatusCode Then
                    Console.Error.WriteLine($"Summarize request failed: {CInt(resp.StatusCode)} {resp.ReasonPhrase}")
