...
$rasterize_client = new Client(['http_errors' => false]);
$rasterize_headers = [
  'api-key' => 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx',
  'Content-Type' => 'application/json'
];
$rasterize_body = '{"id":"'.$uploaded_id.'"}';
$rasterize_request = new Request('POST', 'https://api.pdfrest.com/rasterized-pdf', $rasterize_headers, $rasterize_body);
$rasterize_res = $rasterize_client->sendAsync($rasterize_request)->wait();
echo $rasterize_res->getBody() . PHP_EOL;
