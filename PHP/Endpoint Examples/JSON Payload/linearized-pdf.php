...
$linearize_client = new Client(['http_errors' => false]);
$linearize_headers = [
  'api-key' => 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx',
  'Content-Type' => 'application/json'
];
$linearize_body = '{"id":"'.$uploaded_id.'"}';
$linearize_request = new Request('POST', 'https://api.pdfrest.com/linearized-pdf', $linearize_headers, $linearize_body);
$linearize_res = $linearize_client->sendAsync($linearize_request)->wait();
echo $linearize_res->getBody() . PHP_EOL;
