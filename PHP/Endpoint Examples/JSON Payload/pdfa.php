...
$pdfa_client = new Client(['http_errors' => false]);
$pdfa_headers = [
  'api-key' => 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx',
  'Content-Type' => 'application/json'
];
$pdfa_body = '{"id":"'.$uploaded_id.'", "output_type":"PDF/A-2b"}';
$pdfa_request = new Request('POST', 'https://api.pdfrest.com/pdfa', $pdfa_headers, $pdfa_body);
$pdfa_res = $pdfa_client->sendAsync($pdfa_request)->wait();
echo $pdfa_res->getBody() . PHP_EOL;
