...
$powerpoint_client = new Client(['http_errors' => false]);
$powerpoint_headers = [
  'api-key' => 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx',
  'Content-Type' => 'application/json'
];
$powerpoint_body = '{"id":"'.$uploaded_id.'"}';
$powerpoint_request = new Request('POST', 'https://api.pdfrest.com/powerpoint', $powerpoint_headers, $powerpoint_body);
$powerpoint_res = $powerpoint_client->sendAsync($powerpoint_request)->wait();
echo $powerpoint_res->getBody() . PHP_EOL;
