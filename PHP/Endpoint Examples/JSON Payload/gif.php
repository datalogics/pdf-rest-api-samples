...
$gif_client = new Client(['http_errors' => false]);
$gif_headers = [
  'api-key' => 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx',
  'Content-Type' => 'application/json'
];
$gif_body = '{"id":"'.$uploaded_id.'"}';
$gif_request = new Request('POST', 'https://api.pdfrest.com/gif', $gif_headers, $gif_body);
$gif_res = $gif_client->sendAsync($gif_request)->wait();
echo $gif_res->getBody() . PHP_EOL;
