...
$jpg_client = new Client(['http_errors' => false]);
$jpg_headers = [
  'api-key' => 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx',
  'Content-Type' => 'application/json'
];
$jpg_body = '{"id":"'.$uploaded_id.'"}';
$jpg_request = new Request('POST', 'https://api.pdfrest.com/jpg', $jpg_headers, $jpg_body);
$jpg_res = $jpg_client->sendAsync($jpg_request)->wait();
echo $jpg_res->getBody() . PHP_EOL;
