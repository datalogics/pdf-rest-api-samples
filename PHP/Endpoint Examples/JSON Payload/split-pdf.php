...
$split_client = new Client(['http_errors' => false]);
$split_headers = [
  'api-key' => 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx',
  'Content-Type' => 'application/json'
];
$split_body = '{"id":"'.$uploaded_id.'"}';
$split_request = new Request('POST', 'https://api.pdfrest.com/split-pdf', $split_headers, $split_body);
$split_res = $split_client->sendAsync($split_request)->wait();
echo $split_res->getBody() . PHP_EOL;
