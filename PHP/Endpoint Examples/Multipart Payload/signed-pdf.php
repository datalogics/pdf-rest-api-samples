...
$options = [
  'multipart' => [
    ...
    [
      'name' => 'pfx_credential_file', // Specify the field name for the file.
      'contents' => Utils::tryFopen('/path/to/file', 'r'), // Open the file specified by the '/path/to/file' for reading.
    ...
    [
      'name' => 'pfx_passphrase_file', // Specify the field name for the file.
      'contents' => Utils::tryFopen('/path/to/file', 'r'), // Open the file specified by the '/path/to/file' for reading.
    ...
    [
      'name' => 'logo_file', // Specify the field name for the file.
      'contents' => Utils::tryFopen('/path/to/file', 'r'), // Open the file specified by the '/path/to/file' for reading.
      'filename' => 'filename.png', // Set the filename for the file to be processed, in this case, '/path/to/file'.
      'headers' => [
        'Content-Type' => 'image/png' // Set the Content-Type header for the file.
      ]
    ],
    [
      'name' => 'signature_configuration', // Specify the field name for the digital signature config.
      'contents' => '{"type":"new","name":"esignature","logo_opacity":"0.25","location":{"bottom_left":{ "x":"0", "y":"0" },"top_right":{ "x":"216", "y":"72" },"page":1},"display":{"include_distinguished_name":"true","include_datetime":"true","contact":"My contact info","location":"My location","name":"John Doe","reason":"My reason for signing"}}' // Set the value for the signature configuration. This is a JSON-formatted string.
    ],
    [
...
$request = new Request('POST', $apiUrl.'/signed-pdf', $headers); // Create a new HTTP POST request with the API endpoint and headers.
