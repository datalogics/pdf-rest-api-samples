...
$options = [
  'multipart' => [
    ...
    [
      ...
      'contents' => 'pdfrest_powerpoint' // Set the value for the output option (in this case, 'pdfrest_powerpoint').
    ]
  ]
];

$request = new Request('POST', 'https://api.pdfrest.com/powerpoint', $headers); // Create a new HTTP POST request with the API endpoint and headers.

$res = $client->sendAsync($request, $options)->wait(); // Send the asynchronous request and wait for the response.

echo $res->getBody(); // Output the response body, which contains the PowerPoint document.
