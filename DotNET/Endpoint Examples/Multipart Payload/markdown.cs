 ...
 * - Converts to Markdown via multipart/form-data.
 * - Routed from Program.cs as: `dotnet run -- markdown-multipart <inputFile>`.
 *
 * Setup (environment):
...
namespace Samples.EndpointExamples.MultipartPayload
{
    public static class Markdown
    {
        public static async Task Execute(string[] args)
        {
            ...
            {
                Console.Error.WriteLine("markdown-multipart requires <inputFile>");
                Environment.Exit(1);
                return;
            }
