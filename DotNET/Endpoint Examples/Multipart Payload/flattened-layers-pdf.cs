 ...
 * - Flattens layers via multipart/form-data.
 * - Routed from Program.cs as: `dotnet run -- flattened-layers-pdf-multipart <inputFile>`.
 *
 * Setup (environment):
 ...
 *
 * Usage:
 *   dotnet run -- flattened-layers-pdf-multipart /path/to/input.pdf
 *
 * Output:
...
namespace Samples.EndpointExamples.MultipartPayload
{
    public static class FlattenedLayersPdf
    {
        public static async Task Execute(string[] args)
        {
            ...
            {
                Console.Error.WriteLine("flattened-layers-pdf-multipart requires <inputFile>");
                Environment.Exit(1);
                return;
            }
