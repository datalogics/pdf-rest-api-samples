 ...
 * - Converts an input file to GIF using multipart/form-data.
 * - Routed from Program.cs as: `dotnet run -- gif-multipart <inputFile>`.
 *
 * Setup (environment):
 ...
 *
 * Usage:
 *   dotnet run -- gif-multipart /path/to/input.pdf
 *
 * Output:
...
namespace Samples.EndpointExamples.MultipartPayload
{
    public static class Gif
    {
        public static async Task Execute(string[] args)
        {
            ...
            {
                Console.Error.WriteLine("gif-multipart requires <inputFile>");
                Environment.Exit(1);
                return;
            }
