 ...
 * - Converts an input file to PNG using multipart/form-data.
 * - Routed from Program.cs as: `dotnet run -- png-multipart <inputFile>`.
 *
 * Setup (environment):
 ...
 *
 * Usage:
 *   dotnet run -- png-multipart /path/to/input.pdf
 *
 * Output:
...
namespace Samples.EndpointExamples.MultipartPayload
{
    public static class Png
    {
        public static async Task Execute(string[] args)
        {
            ...
            {
                Console.Error.WriteLine("png-multipart requires <inputFile>");
                Environment.Exit(1);
                return;
            }
