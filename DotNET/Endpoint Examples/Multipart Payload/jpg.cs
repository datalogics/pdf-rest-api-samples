 ...
 * - Converts an input file to JPG using multipart/form-data.
 * - Routed from Program.cs as: `dotnet run -- jpg-multipart <inputFile>`.
 *
 * Setup (environment):
 ...
 *
 * Usage:
 *   dotnet run -- jpg-multipart /path/to/input.pdf
 *
 * Output:
...
namespace Samples.EndpointExamples.MultipartPayload
{
    public static class Jpg
    {
        public static async Task Execute(string[] args)
        {
            ...
            {
                Console.Error.WriteLine("jpg-multipart requires <inputFile>");
                Environment.Exit(1);
                return;
            }
