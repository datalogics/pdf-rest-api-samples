 ...
 * - Uploads a file as a resource using multipart/form-data.
 * - Routed from Program.cs as: `dotnet run -- upload-multipart <inputFile>`.
 *
 * Setup (environment):
...
namespace Samples.EndpointExamples.MultipartPayload
{
    public static class Upload
    {
        public static async Task Execute(string[] args)
        {
            ...
            {
                Console.Error.WriteLine("upload-multipart requires <inputFile>");
                Environment.Exit(1);
                return;
            }
