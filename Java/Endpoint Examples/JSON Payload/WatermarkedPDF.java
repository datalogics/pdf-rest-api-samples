...
public class WatermarkedPDF {
  ...
  public static void main(String[] args) {
    ...
    String JSONString =
        String.format("{\"id\":\"%s\", \"watermark_text\":\"watermark\"}", uploadedID);
    ...
    try {
      ...
      JSONObject watermarkedJSON = new JSONObject(respStr);
      String outputID = watermarkedJSON.optString("outputId");
