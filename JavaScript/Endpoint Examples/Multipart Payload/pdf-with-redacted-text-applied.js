// This request demonstrates how to apply text redactions on an output file from /pdf-with-redacted-text-preview
...
data.append('output', 'pdfrest_pdf-with-redacted-text-applied');
