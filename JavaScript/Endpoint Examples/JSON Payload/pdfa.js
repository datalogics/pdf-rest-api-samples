...
axios(upload_config)
  .then(function (upload_response) {
    ...
    var pdfa_config = {
      ...
      data: { id: uploaded_id, output_type: "PDF/A-2b" }, // set the data to be sent with the request
    };

    // send request and handle response or error
    axios(pdfa_config)
      .then(function (pdfa_response) {
        console.log(JSON.stringify(pdfa_response.data));
      })
