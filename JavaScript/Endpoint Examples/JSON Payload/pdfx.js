...
axios(upload_config)
  .then(function (upload_response) {
    ...
    var pdfx_config = {
      ...
      data: { id: uploaded_id, output_type: "PDF/X-4" }, // set the data to be sent with the request
    };

    // send request and handle response or error
    axios(pdfx_config)
      .then(function (pdfx_response) {
        console.log(JSON.stringify(pdfx_response.data));
      })
