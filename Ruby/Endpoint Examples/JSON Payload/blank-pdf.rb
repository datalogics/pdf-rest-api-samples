...
# - Requests a blank three-page PDF using a JSON payload.
#
# Setup (.env):
...
#
# Usage:
#   ruby "Endpoint Examples/JSON Payload/blank-pdf.rb"
#
# Output:
...
payload = { page_size: "letter", page_count: 3, page_orientation: "portrait" }.to_json
