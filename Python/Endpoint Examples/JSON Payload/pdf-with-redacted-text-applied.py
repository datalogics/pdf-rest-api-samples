...
if upload_response.ok:
    ...
    pdf_with_redacted_text_response = requests.post(url=api_url+'/pdf-with-redacted-text-applied',
    ...
    if pdf_with_redacted_text_response.ok:
        ...
        if DELETE_SENSITIVE_FILES:
            redacted_output_id = pdf_with_redacted_text_response_json['outputId']
            delete_data = { "ids": f"{uploaded_id}, {redacted_output_id}" }
